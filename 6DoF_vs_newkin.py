...
if __name__ == '__main__':
    ...
    if Setup603:
        ...
        image_folder = "./test_data/603_data/image_data"
        robotfile_path = os.path.join("./test_data/603_data/robot_data.txt")
        ...
        robotfile_path = os.path.join("./test_data/16w_data/robot_data.txt") 
    ...
    ply_files = sorted(glob.glob(f'{image_folder}/*_textured_scaled.ply'))
