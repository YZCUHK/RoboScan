...
if __name__ == '__main__':
    ...
    for group, i in zip(group_lists, range(group_num)):
        ...
        tracker_data = pd.read_csv(file_path, sep = ';', encoding='ISO-8859-1') # must add encoding='ISO-8859-1', or it will cause error UnicodeDecodeError: 'utf-8' codec can't decode byte 0xb0 in position 102: invalid start byte
    ...
    for epoch in range(num_epochs):
        ...
        cost = np.sqrt(total_loss.item()/total_point_num) * 1000
